/****************************************************************************
CAMERA.CPP
The CCamera class: The camera implementation (1 or 3 person look).
...
*/
	 ...
	 LookAtPlayer();
     gluLookAt(position.x-25, position.y+20, position.z-25,
              lookAt.x, lookAt.y, lookAt.z,
               0.0, 0.5, 0.0);
}
/**********************/
void CCamera::SetCameraPlayer(CEntity *player)
{
	PositionPlayer=player->position;
}

void CCamera::LookAtPlayer()
{
	lookAt = PositionPlayer;
}
/***********************/